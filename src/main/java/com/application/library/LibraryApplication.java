...
public class LibraryApplication {
	...
	@Bean
	public CommandLineRunner intitialCreate(BookService bookService) {
		return(args) -> {
			Book book1 = new Book("ABC", "Book name", "My first book");
			Author author1 = new Author("Test name", "description");
			...
			Author author2 = new Author("Test name2", "description");
